...
function buildCsp(nonce: string, isProd: boolean): string {
  if (isProd) {
    return [
      ...
      "connect-src 'self' https://api.joycenter.kr:26122 https://oauth2.googleapis.com https://www.googleapis.com https://kapi.kakao.com https://kauth.kakao.com https://dapi.kakao.com wss:",
  ...
  return [
    ...
    "img-src 'self' data: blob: https://*.kakao.com https://*.daumcdn.net https://t1.daumcdn.net https://map.kakao.com https://dapi.kakao.com https://joycenter-s3.s3.eu-north-1.amazonaws.com https://img.youtube.com",
    "font-src 'self' data: https://fonts.gstatic.com https://cdn.jsdelivr.net",
    "connect-src 'self' https://api.joycenter.kr:26122 https://oauth2.googleapis.com https://www.googleapis.com https://kapi.kakao.com https://kauth.kakao.com https://dapi.kakao.com ws: wss:",
    "media-src 'self' data: blob:",
    "frame-src 'self' https://accounts.google.com https://kauth.kakao.com",
    "base-uri 'self'",
    "form-action 'self'",
